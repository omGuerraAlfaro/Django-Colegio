        ...
        .then(data => {
            ...
            switch (data.weather[0].main) {
                case 'Thunderstorm':
                    ...
                    break;
                case 'Drizzle':
                    iconoAnimado.src = 'static/inicio/animated/rainy-2.svg'
                    console.log('LLOVIZNA');
                    break;
                case 'Rain':
                    iconoAnimado.src = 'static/inicio/animated/rainy-7.svg'
                    console.log('LLUVIA');
                    break;
                case 'Snow':
                    iconoAnimado.src = 'static/inicio/animated/snowy-6.svg'
                    console.log('NIEVE');
                    break;
                case 'Clear':
                    ...
                    break;
                case 'Atmosphere':
                    iconoAnimado.src = 'static/inicio/animated/weather.svg'
                    console.log('ATMOSFERA');
                    break;
                case 'Clouds':
                    iconoAnimado.src = 'static/inicio/animated/cloudy-day-1.svg'
                    console.log('NUBES');
                    break;
                default:
                    iconoAnimado.src = 'static/inicio/animated/cloudy-day-1.svg'
                ...
                fetch(url2)
                    ...
                    .then(data2 => {
                        ...
                        switch (data2.weather[0].main) {
                            case 'Thunderstorm':
                                iconoAnimado.src = 'static/inicio/animated/thunder.svg'
                                console.log('TORMENTA');
                                break;
                            case 'Drizzle':
                                iconoAnimado.src = 'static/inicio/animated/rainy-2.svg'
